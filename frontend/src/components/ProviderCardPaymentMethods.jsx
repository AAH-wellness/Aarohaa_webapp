...
import './ProviderCardPaymentMethods.css'

const ProviderCardPaymentMethods = () => {
  ...
  const loadPaymentMethods = async () => {
    try {
      setIsLoading(true)
      const response = await userService.getProviderPaymentMethods()
  ...
  const handleAddCard = async () => {
    ...
    try {
      ...
      const response = await userService.addProviderPaymentMethod(cardData)
  ...
  const handleSetDefault = async (methodId) => {
    try {
      await userService.setDefaultProviderPaymentMethod(methodId)
  ...
  const handleRemoveCard = async (methodId) => {
    ...
    try {
      await userService.removeProviderPaymentMethod(methodId)
  ...
  if (isLoading) {
    return (
      <div className="provider-card-payment-methods">
  ...
  return (
    <div className="provider-card-payment-methods">
      <div className="payment-methods-header">
        ...
        <p className="section-description">Manage your saved cards for platform fees and expenses</p>
      </div>
...
export default ProviderCardPaymentMethods
